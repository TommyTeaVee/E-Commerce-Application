...
public class AddressServiceImpl implements AddressService {
	...
	public AddressDTO createAddress(AddressDTO addressDTO) {
		...
		Address addressFromDB = addressRepo.findByCountryAndStateAndCityAndZipcodeAndStreetAndBuildingName(country,
				state, city, zip, street, buildingName);
	...
	public AddressDTO updateAddress(Long addressId, Address address) {
		Address addressFromDB = addressRepo.findByCountryAndStateAndCityAndZipcodeAndStreetAndBuildingName(
				address.getCountry(), address.getState(), address.getCity(), address.getZipcode(), address.getStreet(),
