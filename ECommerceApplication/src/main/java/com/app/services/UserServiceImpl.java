...
public class UserServiceImpl implements UserService {
	...
	public UserDTO registerUser(UserDTO userDTO) {
		...
		try {
			...
			String zip = userDTO.getAddress().getZipcode();
			String street = userDTO.getAddress().getStreet();
			String buildingName = userDTO.getAddress().getBuildingName();

			Address address = addressRepo.findByCountryAndStateAndCityAndZipcodeAndStreetAndBuildingName(country, state,
					city, zip, street, buildingName);

			if (address == null) {
				address = new Address(country, state, city, zip, street, buildingName);
